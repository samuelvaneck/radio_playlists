...
FactoryBot.define do
  ...
  factory :radio_1, parent: :radiostation do
    name { 'Radio 1' }
    url { 'https://www.nporadio1.nl/api/tracks' }
    processor { 'npo_api_processor' }
  end

  factory :radio_2, parent: :radiostation do
    name { 'Radio 2' }
    url { 'https://www.nporadio2.nl/api/tracks' }
    processor { 'npo_api_processor' }
  end
  
  factory :radio_3_fm, parent: :radiostation do
    name { 'Radio 3FM' }
    url { 'https://www.npo3fm.nl/api/tracks' }
    processor { 'npo_api_processor' }
  end

  factory :radio_5, parent: :radiostation do
    name { 'Radio 5' }
    url { 'https://www.nporadio5.nl/api/tracks' }
    processor { 'npo_api_processor' }
  end

  factory :sky_radio, parent: :radiostation do
    name { 'Sky Radio' }
  ...
  factory :radio_veronica, parent: :radiostation do
    name { 'Radio Veronica' }
  ...
  factory :radio_538, parent: :radiostation do
    name { 'Radio 538' }
  ...
  factory :radio_10, parent: :radiostation do
    name { 'Radio 10' }
  ...
  factory :qmusic, parent: :radiostation do
    name { 'Qmusic' }
    url { 'https://api.qmusic.nl/2.4/tracks/plays?limit=1&next=true' }
    processor { 'qmusic_api_processor' }
  end

  factory :sublime_fm, parent: :radiostation do
    name { 'Sublime FM' }
    url { 'https://sublime.nl/sublime-playlist/' }
    processor { 'scraper' }
  end

  factory :groot_nieuws_radio, parent: :radiostation do
