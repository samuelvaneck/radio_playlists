...
ActiveRecord::Schema[8.1].define(version: 20_251_221_130_000) do
  ...
  create_table 'air_plays', force: :cascade do |t|
    ...
    t.index %w[song_id radio_station_id broadcasted_at], name: 'air_play_radio_song_time', unique: true
  ...
  create_table 'tags', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[name taggable_id taggable_type], name: 'index_tags_on_name_and_taggable_id_and_taggable_type', unique: true
